package com.example.simple_cms.import_google_drive;
...
public class ImportGoogleDrive extends TobBarActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent resultData) {
        ...
        if (requestCode == GoogleDriveManager.RC_SIGN_IN) {
            ...
            Log.e(TAG_DEBUG, "Sign-in failed with resultCode = " + resultCode);
            onFailedLogIn();
        }
    }
